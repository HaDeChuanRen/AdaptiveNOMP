...
plot(SNRvec_all, PDcal_low, '--k+', 'Linewidth', lw);
...
legend('theory ($\bar{\rm P}_{\rm FA} = 0.01$)', ...
'FFT ($\bar{\rm P}_{\rm FA} = 0.01$)', ...
'NOMP-CFAR ($\bar{\rm P}_{\rm FA} = 0.01$)', ...
'theory ($\bar{\rm P}_{\rm FA} = 0.05$)', ...
'FFT ($\bar{\rm P}_{\rm FA} = 0.05$)', ...
