...
filename = 'E:\ti\mmwave_studio_02_00_00_02\mmWaveStudio\PostProc\adc_data.bin';
...
y_matrix = squeeze(data_cube(1 : 128, 65 : 128, 1));
...
[omegaList, gainList, ~, Threshold_collect] = NOMP2D_CFAR(y_matrix, p_fa_CFAR, guard_training_size2D, K_max);
